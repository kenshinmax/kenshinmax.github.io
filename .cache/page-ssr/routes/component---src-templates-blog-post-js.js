...
module.exports = JSON.parse('{"data":{"site":{"siteMetadata":{"title":"Personal Blog","description":"A starter blog demonstrating what Gatsby can do.","social":{"twitter":"kylemathews"}}}}}');
