...
var _react = _interopRequireDefault(__webpack_require__(5733));
...
var React = _interopRequireWildcard(__webpack_require__(5733));
...
var _react = __webpack_require__(5733);
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5733);
...
// EXTERNAL MODULE: external "/Users/cliffsanchez/projects/repos/kenshinmax.github.io/node_modules/react/index.js"
var index_js_ = __webpack_require__(5733);
...
"use strict";
var _interopRequireDefault=__webpack_require__(5318);var _extends2=_interopRequireDefault(__webpack_require__(7154));var _react=_interopRequireDefault(__webpack_require__(5733));var _gatsby=__webpack_require__(7533);var _internals=__webpack_require__(8524);// TODO: remove for v3
...
"use strict";
var _interopRequireDefault=__webpack_require__(5318);var React=_interopRequireWildcard(__webpack_require__(5733));var _gatsby=__webpack_require__(7533);var _common=__webpack_require__(5428);var _getManifestPathname=_interopRequireDefault(__webpack_require__(292));function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: remove for v3
...
"use strict";
var _react=__webpack_require__(5733);var _react2=_interopRequireDefault(_react);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}exports.onRenderBody=function(_ref,pluginOptions){var setHeadComponents=_ref.setHeadComponents;var trackPage=pluginOptions.trackPage,prodKey=pluginOptions.prodKey,devKey=pluginOptions.devKey,_pluginOptions$host=pluginOptions.host,host=_pluginOptions$host===undefined?"https://cdn.segment.io":_pluginOptions$host,delayLoad=pluginOptions.delayLoad,delayLoadTime=pluginOptions.delayLoadTime,manualLoad=pluginOptions.manualLoad,customSnippet=pluginOptions.customSnippet;if(!prodKey||prodKey.length<10)console.error("segment prodKey must be at least 10 char in length");if(devKey&&devKey.length<10)console.error("if present, devKey must be at least 10 char in length");var writeKey= true?prodKey:0;var snippet=void 0;if(customSnippet){snippet=eval('`'+customSnippet+'`');}else{snippet="!function(){var analytics=window.analytics=window.analytics||[];if(!analytics.initialize)if(analytics.invoked)window.console&&console.error&&console.error(\"Segment snippet included twice.\");else{analytics.invoked=!0;analytics.methods=[\"trackSubmit\",\"trackClick\",\"trackLink\",\"trackForm\",\"pageview\",\"identify\",\"reset\",\"group\",\"track\",\"ready\",\"alias\",\"debug\",\"page\",\"once\",\"off\",\"on\",\"addSourceMiddleware\",\"addIntegrationMiddleware\",\"setAnonymousId\",\"addDestinationMiddleware\"];analytics.factory=function(e){return function(){var t=Array.prototype.slice.call(arguments);t.unshift(e);analytics.push(t);return analytics}};for(var e=0;e<analytics.methods.length;e++){var key=analytics.methods[e];analytics[key]=analytics.factory(key)}analytics.load=function(key,e){var t=document.createElement(\"script\");t.type=\"text/javascript\";t.async=!0;t.src=\""+host+"/analytics.js/v1/\" + key + \"/analytics.min.js\";var n=document.getElementsByTagName(\"script\")[0];n.parentNode.insertBefore(t,n);analytics._loadOptions=e};analytics._writeKey=\""+writeKey+"\";analytics.SNIPPET_VERSION=\"4.13.2\";";if(!(delayLoad||manualLoad)){snippet+="\nanalytics.load('"+writeKey+"');";if(trackPage){snippet+='analytics.page();';}}snippet+='\n}}();';}var delayedLoader="\n      window.segmentSnippetLoaded = false;\n      window.segmentSnippetLoading = false;\n\n      window.segmentSnippetLoader = function (callback) {\n        if (!window.segmentSnippetLoaded && !window.segmentSnippetLoading) {\n          window.segmentSnippetLoading = true;\n\n          function loader() {\n            window.analytics.load('"+writeKey+"');"+(trackPage?'window.analytics.page();':'')+"\n            window.segmentSnippetLoading = false;\n            window.segmentSnippetLoaded = true;\n            if(callback) {callback()}\n          };\n\n          setTimeout(\n            function () {\n              \"requestIdleCallback\" in window\n                ? requestIdleCallback(function () {loader()})\n                : loader();\n            },\n            "+delayLoadTime+" || 1000\n          );\n        }\n      }\n      window.addEventListener('scroll',function () {window.segmentSnippetLoader()}, { once: true });\n    ";var snippetToUse="\n      "+(delayLoad&&!manualLoad?delayedLoader:"")+"\n      "+snippet+"\n    ";if(writeKey){setHeadComponents([_react2.default.createElement("script",{key:"plugin-segment",dangerouslySetInnerHTML:{__html:snippetToUse}})]);}};
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5733);
...
var React = __webpack_require__(5733);
...
"use strict";
module.exports = require("/Users/cliffsanchez/projects/repos/kenshinmax.github.io/.cache/ssr-builtin-trackers/fs");
...
"use strict";
module.exports = require("/Users/cliffsanchez/projects/repos/kenshinmax.github.io/node_modules/react-dom/server.js");
...
"use strict";
module.exports = require("/Users/cliffsanchez/projects/repos/kenshinmax.github.io/node_modules/react/index.js");
...
"use strict";
module.exports = JSON.parse('{"polyfill":["/polyfill-67664a8ccc6c9f02b880.js"],"app":["/app-356b59bd4fe3ab574a7c.js"],"component---src-pages-404-js":["/component---src-pages-404-js-27981ca7dd461cb4280e.js"],"component---src-pages-index-js":["/component---src-pages-index-js-b67d3ee84e3afdfd0630.js"],"component---src-pages-using-typescript-tsx":["/component---src-pages-using-typescript-tsx-422222b701089fbe3088.js"],"component---src-templates-blog-post-js":["/component---src-templates-blog-post-js-30d80a19999e78d03acb.js"]}');
